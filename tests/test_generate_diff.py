...
def test_generate_diff(test_result, test_compare_file1, test_compare_file2, test_compare_nested_files, test_compare_nested_files3, test_compare_nested_files4, test_plain, test_plain1, test_json, test_json1):
    ...
    assert generate_diff("tests/fixtures/files/file3.json", "tests/fixtures/files/file4.json", format=json_format) == test_json
    assert generate_diff("tests/fixtures/files/file3.json", "tests/fixtures/files/file2.yml", format=json_format) == test_json1
